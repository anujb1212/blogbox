...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\ANUJ BAJPAI\\Projects\\blogbox\\backend\\src\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\ANUJ BAJPAI\\Projects\\blogbox\\backend\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "prisma://accelerate.prisma-data.net/?api_key=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcGlfa2V5IjoiYThjNWIyYTYtOTI4Ni00NmQ1LWJkMjktM2IyMjQyMzRkMzMyIiwidGVuYW50X2lkIjoiZjk4MTY3Yzc4MzhjZjIyZWVmMDhlYzdhYzhiOGNlOTE5YmRmMDZlZDVkN2M2MmM4YzYyYTJiNTdlNGQ5Njk0YSIsImludGVybmFsX3NlY3JldCI6IjM0OTFjY2VkLWI0ZGYtNGY4ZC04ZGQ5LTY0ZTAyNTMyZjI4YSJ9.EWOfgKY1KhfrXaXvplC6ryw-gy6r0141CN7f4kDT6Po"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider   = \"prisma-client-js\"\n  output     = \"../src/generated/prisma\"\n  engineType = \"edge\"\n}\n\ndatasource db {\n  provider  = \"postgresql\"\n  url       = env(\"DATABASE_URL\")\n  directUrl = env(\"DIRECT_URL\")\n}\n\nmodel User {\n  id       String  @id @default(uuid())\n  email    String  @unique\n  name     String?\n  password String\n  posts    Post[]\n}\n\nmodel Post {\n  id        String   @id @default(uuid())\n  title     String\n  content   String\n  createdAt DateTime @default(now()) // <-- THIS MUST EXIST\n  author    User     @relation(fields: [authorId], references: [id])\n  authorId  String\n}\n",
  "inlineSchemaHash": "74c0eb0bcc487cc6fec05c8a121bab8dbb4c30f15e78e04a7bf4c5522f189f20",
  "copyEngine": true
}
config.dirname = '/'
