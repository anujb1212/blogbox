    ...
    return (
        <div className="bg-slate-100 min-h-screen flex flex-col justify-center items-center text-center px-4">
            ...
            <div className="flex gap-4">
                <Link to="/signup">
                    <button className="bg-blue-600 text-white px-6 py-2 rounded-lg text-sm hover:bg-blue-700 transition-all">
                        Get Started
                    </button>
                </Link>
                <Link to="/signin">
                    <button className="border border-blue-600 text-blue-600 px-6 py-2 rounded-lg text-sm hover:bg-blue-50 transition-all">
